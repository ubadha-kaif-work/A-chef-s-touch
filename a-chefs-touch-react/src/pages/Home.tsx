...
const testimonialsData = [
  {
    name: "Sarah Ahmed",
    review:
      "The Mutton Haleem here is absolutely divine. Perfect balance of spices and the texture is incredibly rich. Just like homemade!",
    rating: 5,
    date: "March 10, 2026",
  },
  {
    name: "Farhaan K.",
    review:
      "Ordered the Chicken Tikka Cones for a family gathering and they were a massive hit. The kids loved them and the delivery was exactly on time.",
    rating: 5,
  ...
  },
  {
    name: "Ayesha S.",
    review:
      "The best place in Vaniyambadi for authentic Ramzan snacks. The Spring Chicken is perfectly crispy every single time.",
    rating: 4,
    date: "March 05, 2026",
  },
  {
    name: "Rizwan M.",
    review:
      "Their Butter Chicken gravy is insanely good. I highly recommend pre-ordering it for weekend dinners. Portions are generous too.",
    rating: 5,
    date: "March 11, 2026",
  },
  {
    name: "Zainab Faheem",
    review:
      "I’ve tried almost all their desserts. The Lab E Khaas is an absolute must-try! Very premium packaging and great taste.",
    rating: 5,
        ...
        <div className="hero-content">
          ...
          <div className="hero-btns">
            ...
            <div className="delivery-badge">
              <i className="fa-solid fa-motorcycle" aria-hidden="true"></i> Free
              Delivery Available
            </div>
          </div>
        </div>
